  ...
  return (
    <div className="pt-20">
      ...
      <div className="relative py-24 overflow-hidden" style={{ background: 'linear-gradient(135deg, #0D47A1 0%, #1565C0 60%, #1976D2 100%)' }}>
        ...
        <img src="https://images.pexels.com/photos/4246120/pexels-photo-4246120.jpeg?auto=compress&cs=tinysrgb&w=1400&h=600&fit=crop" alt="Professional moving crew loading household boxes into a truck" loading="eager" className="absolute inset-0 w-full h-full object-cover opacity-10" />
