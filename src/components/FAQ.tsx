        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className={`lg:sticky lg:top-28 ${inView ? 'animate-reveal-left' : 'opacity-0'}`}>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a href="tel:+18182784544" className="flex items-center gap-2 px-5 py-3.5 rounded-xl border border-slate-200 text-slate-700 font-semibold text-sm hover:bg-white hover:shadow-md transition-all" style={{ textDecoration: 'none' }}>
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
