...
import { generatePackingList } from '@/server/services/document.service';
...
export async function GET(
  ...
  try {
    ...
    const { buffer, filename } = await generatePackingList(shipment as unknown as TemplateShipment);
